...
// 1-Determine if the poker hand is flush
...
// // every() checks if every element in the array passes a specific test. so since we only
// //care if( the last index of each element are equal to one another then .slice(-1) would be the best choice.